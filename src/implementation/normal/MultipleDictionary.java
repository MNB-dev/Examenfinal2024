...
public class MultipleDictionary implements IMultipleDictionary {
    ...
    public boolean existsValue(ISet set, int value) {
        ISet copy = new Set();
    ...
    public MultipleDictionary copy() {
        MultipleDictionary copiedDictionary = new MultipleDictionary();

        // Copiar las claves y valores
        copiedDictionary.keys = Arrays.copyOf(this.keys, this.size);
        copiedDictionary.values = Arrays.copyOf(this.values, this.size);
        copiedDictionary.size = this.size;
